...
public class GameManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Vector3 blueTimer = GameObject.Find("Button-Timer Blue").transform.position;
        //Vector3 redTimer = GameObject.Find("Button-Timer Red").transform.position;
        //Vector3 greenTimer = GameObject.Find("Button-Timer Green").transform.position;
        //Vector3 yellowTimer = GameObject.Find("Button-Timer Yellow").transform.position;
    ...
    void Initialize()
    {
        ...
        //blueTimer = GameObject.Find("Button-Timer Blue").transform.position;
    ...
    bool MakeOneMoveDownIndex(Tile[] LineOfTiles) {
        ...
        for (int i = 0; i < LineOfTiles.Length - 1; i++) {
            ...
            if (LineOfTiles[i].Number != 0 && LineOfTiles[i].Number == LineOfTiles[i + 1].Number && LineOfTiles[i].mergeThisTile == false && LineOfTiles[i + 1].mergeThisTile == false) {
                ...
                //        if (LineOfTiles[i + 1].MiniTiles[y].GetComponent<Image>().enabled && LineOfTiles[i].MiniTiles[1].GetComponent<Image>().enabled == false || LineOfTiles[i].MiniTiles[2].GetComponent<Image>().enabled == false || LineOfTiles[i].MiniTiles[3].GetComponent<Image>().enabled == false || LineOfTiles[i].MiniTiles[4].GetComponent<Image>().enabled == false) {
                ...
                //    if (LineOfTiles[i].MiniTiles[y].GetComponent<Image>().enabled == true) {
                //        LineOfTiles[i].miniTilesCount = LineOfTiles[i].miniTilesCount + 1;
                //    }
                ...
                //    if (LineOfTiles[i + 1].MiniTiles[y].GetComponent<Image>().enabled == true) {
                //        LineOfTiles[i + 1].miniTilesCount = LineOfTiles[i + 1].miniTilesCount + 1;
                //    }
                ...
                //bool color1 = LineOfTiles[i + 1].MiniTiles[0].GetComponent<Image>().enabled && (LineOfTiles[i + 1].MiniTiles[0].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[0].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[0].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[1].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[0].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[2].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[0].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[3].GetComponent<Image>().color);
                //bool color2 = LineOfTiles[i + 1].MiniTiles[1].GetComponent<Image>().enabled && (LineOfTiles[i + 1].MiniTiles[1].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[0].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[1].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[1].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[1].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[2].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[1].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[3].GetComponent<Image>().color);
                //bool color3 = LineOfTiles[i + 1].MiniTiles[2].GetComponent<Image>().enabled && (LineOfTiles[i + 1].MiniTiles[2].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[0].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[2].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[1].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[2].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[2].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[2].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[3].GetComponent<Image>().color);
                //bool color4 = LineOfTiles[i + 1].MiniTiles[3].GetComponent<Image>().enabled && (LineOfTiles[i + 1].MiniTiles[3].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[0].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[3].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[1].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[3].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[2].GetComponent<Image>().color || LineOfTiles[i + 1].MiniTiles[3].GetComponent<Image>().color == LineOfTiles[i].MiniTiles[3].GetComponent<Image>().color);
    ...
    bool MakeOneMoveUpIndex(Tile[] LineOfTiles) {
        for (int i = LineOfTiles.Length - 1; i > 0; i--) {
            ...
            if (LineOfTiles[i].Number != 0 && LineOfTiles[i].Number == LineOfTiles[i - 1].Number && LineOfTiles[i].mergeThisTile == false && LineOfTiles[i - 1].mergeThisTile == false)
            {
                ...
                //    if (LineOfTiles[i - 1].MiniTiles[y].GetComponent<Image>().enabled == true) {
                //        LineOfTiles[i - 1].miniTilesCount++;
                //    }
...
// The color of tile is not shown in debug Maybe need to put it ti update or look in google for the answer
// After displaying GameOver panel still tiles is movable,need some modification with canMove boolean
// Need use delay method in 0.01 but without glitch
// Need post in unity forum ask for 2048 grid script...